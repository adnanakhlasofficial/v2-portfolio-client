    ...
    <Section>
      <div className="relative flex flex-col items-center justify-center">
        ...
        <div className="relative mx-auto space-y-4 text-center">
          <div className="bg-muted/50 border-border text-foreground animate-fade-in hover:text-primary inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-medium backdrop-blur-sm transition-colors duration-300">
          ...
          <p className="text-muted-foreground animate-fade-in-up mx-auto max-w-3xl text-base leading-relaxed delay-300 sm:text-lg">
            I craft beautiful, performant web experiences that blend innovative design with
            cutting-edge technology. Passionate about building products that make a difference.
          </p>
